...
Java_com_example_drishtiai_smolvectordb_SmolVectorDB_initialize(JNIEnv* env, jobject thiz) {
    VectorDB* db = new VectorDB();
    return reinterpret_cast<jlong>(db);
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smolvectordb_SmolVectorDB_insertRecord(JNIEnv* env, jobject thiz, jlong handle, jstring text,
...
Java_com_example_drishtiai_smolvectordb_SmolVectorDB_nearestNeighbor(JNIEnv* env, jobject thiz, jlong handle,
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smolvectordb_SmolVectorDB_close(JNIEnv* env, jobject thiz, jlong handle) {
    VectorDB* db = reinterpret_cast<VectorDB*>(handle);
    delete db;
}
