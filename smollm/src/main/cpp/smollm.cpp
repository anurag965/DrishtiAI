...
Java_com_example_drishtiai_smollm_SmolLM_loadModel(JNIEnv* env, jobject thiz, jstring modelPath, jfloat minP,
...
Java_com_example_drishtiai_smollm_SmolLM_addChatMessage(JNIEnv* env, jobject thiz, jlong modelPtr, jstring message,
                                                 jstring role) {
    jboolean    isCopy       = true;
...
Java_com_example_drishtiai_smollm_SmolLM_getResponseGenerationSpeed(JNIEnv* env, jobject thiz, jlong modelPtr) {
    auto* llmInference = reinterpret_cast<LLMInference*>(modelPtr);
    return llmInference->getResponseGenerationTime();
}

extern "C" JNIEXPORT jint JNICALL
Java_com_example_drishtiai_smollm_SmolLM_getContextSizeUsed(JNIEnv* env, jobject thiz, jlong modelPtr) {
    auto* llmInference = reinterpret_cast<LLMInference*>(modelPtr);
    return llmInference->getContextSizeUsed();
}

extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smollm_SmolLM_close(JNIEnv* env, jobject thiz, jlong modelPtr) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smollm_SmolLM_startCompletion(JNIEnv* env, jobject thiz, jlong modelPtr, jstring prompt) {
    jboolean    isCopy       = true;
...
Java_com_example_drishtiai_smollm_SmolLM_completionLoop(JNIEnv* env, jobject thiz, jlong modelPtr) {
    auto* llmInference = reinterpret_cast<LLMInference*>(modelPtr);
    try {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smollm_SmolLM_stopCompletion(JNIEnv* env, jobject thiz, jlong modelPtr) {
    auto* llmInference = reinterpret_cast<LLMInference*>(modelPtr);
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_example_drishtiai_smollm_SmolLM_loadMultimodalModel(JNIEnv* env,
                                                      jobject thiz,
                                                      jstring modelPath,
                                                      jstring mmprojPath,
                                                      jfloat minP,
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smollm_SmolLM_addVideoFrame(JNIEnv* env,
                                                jobject thiz,
                                                jlong modelPtr,
                                                jbyteArray data,
                                                jint width,
...
Java_com_example_drishtiai_smollm_SmolLM_buildMultimodalChat(JNIEnv* env,
                                                      jobject thiz,
                                                      jlong modelPtr,
                                                      jstring prompt) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_example_drishtiai_smollm_SmolLM_clearVideoFrames(JNIEnv* env,
                                                   jobject thiz,
                                                   jlong modelPtr) {
...
extern "C" JNIEXPORT jint JNICALL
Java_com_example_drishtiai_smollm_SmolLM_getFrameCount(JNIEnv* env,
                                                jobject thiz,
                                                jlong modelPtr) {
    auto* llmInference = reinterpret_cast<LLMInference*>(modelPtr);
